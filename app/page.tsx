...
export default function Home() {
  return (
    <main className="min-h-screen bg-gradient-to-br from-blue-900 via-indigo-900 to-purple-800 text-white">
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-8 py-20 md:py-28 grid md:grid-cols-2 gap-12 md:gap-16 items-center">

        {/* LEFT SIDE */}
        <div>

          <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold leading-tight bg-gradient-to-r from-cyan-400 to-purple-400 bg-clip-text text-transparent">
            Smart Academic
            <br />
            Command Center
          </h1>
          ...
          <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 mt-10">
            ...
            <Link
              href="/create-school"
              className="px-6 py-3 rounded-xl text-center bg-gradient-to-r from-cyan-500 to-purple-600 font-semibold hover:scale-105 transition"
            >
              Create School
            </Link>
            ...
            <Link
              href="/erp/login"
              className="px-6 py-3 rounded-xl text-center border border-cyan-400 text-cyan-300 hover:bg-white/10 transition"
            >
              ERP Login
            </Link>
