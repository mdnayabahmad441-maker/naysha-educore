...
export default function FeeReceipt({ student, fee, payment, school, showActions = true }: FeeReceiptProps) {
  ...
  return (
    <div className="mx-auto w-full max-w-4xl print:max-w-none print:bg-white" style={{ backgroundColor: "#f4efe6", color: "#0f172a" }}>
      <div
        className="overflow-visible rounded-[30px] print:rounded-none print:border-0 print:bg-white print:shadow-none"
        style={{
      ...
      >
        ...
        <div className="p-7 sm:p-10 print:p-8">
          <div className="flex flex-col gap-6 pb-8 sm:flex-row sm:items-start sm:justify-between" style={{ borderBottom: "1px solid #d7c9ad" }}>
            <div className="min-w-0">
              <p className="text-[11px] font-semibold uppercase tracking-[0.38em]" style={{ color: "#8b6a2f" }}>
                Premium Fee Receipt
              </p>
              <h1 className="mt-3 break-words text-3xl font-semibold leading-[1.18] tracking-[-0.02em] sm:text-[2.35rem]" style={{ color: "#020617" }}>
                {school?.name || "School"}
              </h1>

              {school?.address ? (
                <p className="mt-3 max-w-2xl text-sm leading-6" style={{ color: "#475569" }}>
                  {school.address}
                </p>
              ) : null}

              {school?.phone ? (
                <p className="mt-1 text-sm font-medium" style={{ color: "#334155" }}>
            ...
            <div
              className="grid min-w-[250px] gap-3 rounded-[24px] p-5 text-sm"
          ...
          <div className="mt-8 grid gap-6 lg:grid-cols-[1.08fr_0.92fr]">
            <section className="rounded-[26px] p-6" style={{ border: "1px solid #d7c9ad", backgroundColor: "rgba(255,255,255,0.85)", boxShadow: "0 12px 32px rgba(15,23,42,0.06)" }}>
              <div className="mb-5 flex items-center justify-between gap-4">
                <h2 className="text-lg font-semibold" style={{ color: "#020617" }}>Student Billing Details</h2>
                <div className="rounded-full px-3 py-1 text-xs font-semibold uppercase tracking-[0.22em]" style={{ backgroundColor: "#f7efdd", color: "#8b6a2f" }}>
                  Verified
                </div>
              </div>
              ...
              <div className="grid gap-x-8 gap-y-4 sm:grid-cols-2">
                <div>
                  ...
                  <p className="mt-1 text-base font-semibold" style={{ color: "#0f172a" }}>{student?.name || "N/A"}</p>
                </div>
                <div>
                  <p className="text-xs font-medium uppercase tracking-[0.18em]" style={{ color: "#64748b" }}>Student ID</p>
                  <p className="mt-1 text-base font-semibold" style={{ color: "#0f172a" }}>{student?.student_code || "N/A"}</p>
                </div>
                <div>
                  <p className="text-xs font-medium uppercase tracking-[0.18em]" style={{ color: "#64748b" }}>Class</p>
                  <p className="mt-1 text-base font-semibold" style={{ color: "#0f172a" }}>{student?.class_name || "N/A"}</p>
                </div>
                <div>
                  <p className="text-xs font-medium uppercase tracking-[0.18em]" style={{ color: "#64748b" }}>Roll Number</p>
                  <p className="mt-1 text-base font-semibold" style={{ color: "#0f172a" }}>{student?.roll_number || "N/A"}</p>
                </div>
                <div>
                  <p className="text-xs font-medium uppercase tracking-[0.18em]" style={{ color: "#64748b" }}>Parent / Guardian</p>
                  <p className="mt-1 text-base font-semibold" style={{ color: "#0f172a" }}>{student?.parent_name || "N/A"}</p>
                </div>
                <div>
                  <p className="text-xs font-medium uppercase tracking-[0.18em]" style={{ color: "#64748b" }}>Contact Number</p>
                  <p className="mt-1 text-base font-semibold" style={{ color: "#0f172a" }}>{student?.parent_phone || "N/A"}</p>
                </div>
              </div>

              {student?.parent_email ? (
                <div className="mt-5 pt-4" style={{ borderTop: "1px solid #eadfca" }}>
            ...
            <section className="rounded-[26px] p-6" style={{ border: "1px solid #d7c9ad", background: "linear-gradient(180deg,#fffdfa 0%,#f9f1e3 100%)", boxShadow: "0 12px 32px rgba(15,23,42,0.06)" }}>
              <p className="text-xs font-semibold uppercase tracking-[0.28em]" style={{ color: "#8b6a2f" }}>
                Payment Summary
              </p>
              <p className="mt-3 text-4xl font-semibold leading-none" style={{ color: "#020617" }}>
              ...
              <div className="mt-6 grid gap-3">
                <div className="flex items-center justify-between rounded-2xl px-4 py-3" style={{ border: "1px solid #e7d9bd", backgroundColor: "rgba(255,255,255,0.8)" }}>
          ...
          <div className="mt-8 overflow-hidden rounded-[26px]" style={{ border: "1px solid #d7c9ad", backgroundColor: "rgba(255,255,255,0.9)", boxShadow: "0 12px 32px rgba(15,23,42,0.06)" }}>
            <div className="grid grid-cols-[minmax(0,1fr)_180px] px-5 py-4 text-xs font-semibold uppercase tracking-[0.18em]" style={{ backgroundColor: "#f9f1e3", color: "#334155" }}>
              <div>Fee Head</div>
            ...
            <div>
              {breakdown.map((item) => (
                <div key={item.label} className="grid grid-cols-[minmax(0,1fr)_180px] px-5 py-4 text-sm" style={{ borderTop: "1px solid #eee2ca" }}>
              ...
              <div className="grid grid-cols-[minmax(0,1fr)_180px] px-5 py-4 text-sm" style={{ borderTop: "1px solid #eee2ca", backgroundColor: "#fcf7ee" }}>
              ...
              <div className="grid grid-cols-[minmax(0,1fr)_180px] px-5 py-4 text-sm" style={{ borderTop: "1px solid #eee2ca", backgroundColor: "#fffaf2" }}>
          ...
          <div className="mt-8 flex flex-col gap-4 pt-6 text-sm sm:flex-row sm:items-end sm:justify-between" style={{ borderTop: "1px solid #d7c9ad", color: "#475569" }}>
            <div>
